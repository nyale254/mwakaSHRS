...
<head>
    ...
    <link rel="stylesheet" href="/Mwaka.SHRS.2/styles/health_record.css">
...
<div class="container">
    <aside class="sidebar" id="sidebar">
        ...
        <ul>
            ...
            <li><a href="#" class="nav-link" data-page="student_list.php">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#0000F5">
            ...
            <li><a href="#" class="nav-link" data-page="health_records.php">
               <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#0000F5">
            ...
            <li><a href="#" class="nav-link" data-page="vaccination.php">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#0000F5">
            ...
            <li><a href="#" class="nav-link" data-page="treatment.php">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#0000F5">
            ...
            <div class="header-content">
                <div class="header-left">
                   ...
                   <div class="search-box">
                        ...
                        <input type="search" id="searchInput"placeholder="Search by name, ID, email..." autocomplete="off"
